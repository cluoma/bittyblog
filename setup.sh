...
sqlite3 bittyblog.db "CREATE TABLE \`posts\` (\`id\` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT UNIQUE, \`page_id\` INTEGER, \`title\` TEXT, \`text\` TEXT, \`time\` INTEGER NOT NULL, \`extra\` TEXT, \`byline\` TEXT, \`thumbnail\` TEXT, \`visible\` INTEGER, FOREIGN KEY(\`page_id\`) REFERENCES pages ( id ));"
